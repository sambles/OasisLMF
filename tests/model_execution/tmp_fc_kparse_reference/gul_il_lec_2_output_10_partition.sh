...
mkfifo /tmp/%FIFO_DIR%/fifo/gul_S2_summaryeltcalc_P3
mkfifo /tmp/%FIFO_DIR%/fifo/gul_S2_eltcalc_P3
mkfifo /tmp/%FIFO_DIR%/fifo/gul_S2_summarysummarycalc_P3
...
mkfifo /tmp/%FIFO_DIR%/fifo/gul_S2_summaryeltcalc_P6
mkfifo /tmp/%FIFO_DIR%/fifo/gul_S2_eltcalc_P6
mkfifo /tmp/%FIFO_DIR%/fifo/gul_S2_summarysummarycalc_P6
...
mkfifo /tmp/%FIFO_DIR%/fifo/gul_S2_summaryeltcalc_P7
mkfifo /tmp/%FIFO_DIR%/fifo/gul_S2_eltcalc_P7
mkfifo /tmp/%FIFO_DIR%/fifo/gul_S2_summarysummarycalc_P7
...
mkfifo /tmp/%FIFO_DIR%/fifo/gul_S2_summaryeltcalc_P8
mkfifo /tmp/%FIFO_DIR%/fifo/gul_S2_eltcalc_P8
mkfifo /tmp/%FIFO_DIR%/fifo/gul_S2_summarysummarycalc_P8
...
mkfifo /tmp/%FIFO_DIR%/fifo/gul_S2_summaryeltcalc_P9
mkfifo /tmp/%FIFO_DIR%/fifo/gul_S2_eltcalc_P9
mkfifo /tmp/%FIFO_DIR%/fifo/gul_S2_summarysummarycalc_P9
...
mkfifo /tmp/%FIFO_DIR%/fifo/gul_S2_summaryeltcalc_P10
mkfifo /tmp/%FIFO_DIR%/fifo/gul_S2_eltcalc_P10
mkfifo /tmp/%FIFO_DIR%/fifo/gul_S2_summarysummarycalc_P10
...
mkfifo /tmp/%FIFO_DIR%/fifo/il_S2_summaryeltcalc_P3
mkfifo /tmp/%FIFO_DIR%/fifo/il_S2_eltcalc_P3
mkfifo /tmp/%FIFO_DIR%/fifo/il_S2_summarysummarycalc_P3
...
mkfifo /tmp/%FIFO_DIR%/fifo/il_S2_summaryeltcalc_P6
mkfifo /tmp/%FIFO_DIR%/fifo/il_S2_eltcalc_P6
mkfifo /tmp/%FIFO_DIR%/fifo/il_S2_summarysummarycalc_P6
...
mkfifo /tmp/%FIFO_DIR%/fifo/il_S2_summaryeltcalc_P7
mkfifo /tmp/%FIFO_DIR%/fifo/il_S2_eltcalc_P7
mkfifo /tmp/%FIFO_DIR%/fifo/il_S2_summarysummarycalc_P7
...
mkfifo /tmp/%FIFO_DIR%/fifo/il_S2_summaryeltcalc_P8
mkfifo /tmp/%FIFO_DIR%/fifo/il_S2_eltcalc_P8
mkfifo /tmp/%FIFO_DIR%/fifo/il_S2_summarysummarycalc_P8
...
mkfifo /tmp/%FIFO_DIR%/fifo/il_S2_summaryeltcalc_P9
mkfifo /tmp/%FIFO_DIR%/fifo/il_S2_eltcalc_P9
mkfifo /tmp/%FIFO_DIR%/fifo/il_S2_summarysummarycalc_P9
...
mkfifo /tmp/%FIFO_DIR%/fifo/il_S2_summaryeltcalc_P10
mkfifo /tmp/%FIFO_DIR%/fifo/il_S2_eltcalc_P10
mkfifo /tmp/%FIFO_DIR%/fifo/il_S2_summarysummarycalc_P10
...
mkfifo /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summaryeltcalc_P3
mkfifo /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_eltcalc_P3
mkfifo /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarysummarycalc_P3
mkfifo /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarycalc_P3
mkfifo /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarypltcalc_P3
...
mkfifo /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summaryeltcalc_P4
mkfifo /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_eltcalc_P4
mkfifo /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarysummarycalc_P4
mkfifo /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarycalc_P4
mkfifo /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarypltcalc_P4
...
mkfifo /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summaryeltcalc_P5
mkfifo /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_eltcalc_P5
mkfifo /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarysummarycalc_P5
mkfifo /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarycalc_P5
mkfifo /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarypltcalc_P5
...
mkfifo /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summaryeltcalc_P6
mkfifo /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_eltcalc_P6
mkfifo /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarysummarycalc_P6
mkfifo /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarycalc_P6
mkfifo /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarypltcalc_P6
...
mkfifo /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summaryeltcalc_P7
mkfifo /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_eltcalc_P7
mkfifo /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarysummarycalc_P7
mkfifo /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarycalc_P7
mkfifo /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarypltcalc_P7
...
mkfifo /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summaryeltcalc_P8
mkfifo /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_eltcalc_P8
mkfifo /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarysummarycalc_P8
mkfifo /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarycalc_P8
mkfifo /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarypltcalc_P8
...
mkfifo /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summaryeltcalc_P9
mkfifo /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_eltcalc_P9
mkfifo /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarysummarycalc_P9
mkfifo /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarycalc_P9
mkfifo /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarypltcalc_P9
...
mkfifo /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summaryeltcalc_P10
mkfifo /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_eltcalc_P10
mkfifo /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarysummarycalc_P10
mkfifo /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarycalc_P10
mkfifo /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarypltcalc_P10
...
mkfifo /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summaryeltcalc_P3
mkfifo /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_eltcalc_P3
mkfifo /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summarysummarycalc_P3
mkfifo /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summarycalc_P3
mkfifo /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summarypltcalc_P3
...
mkfifo /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summaryeltcalc_P4
mkfifo /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_eltcalc_P4
mkfifo /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summarysummarycalc_P4
mkfifo /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summarycalc_P4
mkfifo /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summarypltcalc_P4
...
mkfifo /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summaryeltcalc_P5
mkfifo /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_eltcalc_P5
mkfifo /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summarysummarycalc_P5
mkfifo /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summarycalc_P5
mkfifo /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summarypltcalc_P5
...
mkfifo /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summaryeltcalc_P6
mkfifo /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_eltcalc_P6
mkfifo /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summarysummarycalc_P6
mkfifo /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summarycalc_P6
mkfifo /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summarypltcalc_P6
...
mkfifo /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summaryeltcalc_P7
mkfifo /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_eltcalc_P7
mkfifo /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summarysummarycalc_P7
mkfifo /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summarycalc_P7
mkfifo /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summarypltcalc_P7
...
mkfifo /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summaryeltcalc_P8
mkfifo /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_eltcalc_P8
mkfifo /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summarysummarycalc_P8
mkfifo /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summarycalc_P8
mkfifo /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summarypltcalc_P8
...
mkfifo /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summaryeltcalc_P9
mkfifo /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_eltcalc_P9
mkfifo /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summarysummarycalc_P9
mkfifo /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summarycalc_P9
mkfifo /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summarypltcalc_P9
...
mkfifo /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summaryeltcalc_P10
mkfifo /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_eltcalc_P10
mkfifo /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summarysummarycalc_P10
mkfifo /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summarycalc_P10
mkfifo /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summarypltcalc_P10
...
eltcalc -s < /tmp/%FIFO_DIR%/fifo/il_S1_summaryeltcalc_P3 > work/kat/il_S1_eltcalc_P3 & pid13=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/il_S1_summarysummarycalc_P3 > work/kat/il_S1_summarycalc_P3 & pid14=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/il_S1_summarypltcalc_P3 > work/kat/il_S1_pltcalc_P3 & pid15=$!
eltcalc -s < /tmp/%FIFO_DIR%/fifo/il_S2_summaryeltcalc_P3 > work/kat/il_S2_eltcalc_P3 & pid16=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/il_S2_summarysummarycalc_P3 > work/kat/il_S2_summarycalc_P3 & pid17=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/il_S2_summarypltcalc_P3 > work/kat/il_S2_pltcalc_P3 & pid18=$!
eltcalc -s < /tmp/%FIFO_DIR%/fifo/il_S1_summaryeltcalc_P4 > work/kat/il_S1_eltcalc_P4 & pid19=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/il_S1_summarysummarycalc_P4 > work/kat/il_S1_summarycalc_P4 & pid20=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/il_S1_summarypltcalc_P4 > work/kat/il_S1_pltcalc_P4 & pid21=$!
eltcalc -s < /tmp/%FIFO_DIR%/fifo/il_S2_summaryeltcalc_P4 > work/kat/il_S2_eltcalc_P4 & pid22=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/il_S2_summarysummarycalc_P4 > work/kat/il_S2_summarycalc_P4 & pid23=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/il_S2_summarypltcalc_P4 > work/kat/il_S2_pltcalc_P4 & pid24=$!
eltcalc -s < /tmp/%FIFO_DIR%/fifo/il_S1_summaryeltcalc_P5 > work/kat/il_S1_eltcalc_P5 & pid25=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/il_S1_summarysummarycalc_P5 > work/kat/il_S1_summarycalc_P5 & pid26=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/il_S1_summarypltcalc_P5 > work/kat/il_S1_pltcalc_P5 & pid27=$!
eltcalc -s < /tmp/%FIFO_DIR%/fifo/il_S2_summaryeltcalc_P5 > work/kat/il_S2_eltcalc_P5 & pid28=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/il_S2_summarysummarycalc_P5 > work/kat/il_S2_summarycalc_P5 & pid29=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/il_S2_summarypltcalc_P5 > work/kat/il_S2_pltcalc_P5 & pid30=$!
eltcalc -s < /tmp/%FIFO_DIR%/fifo/il_S1_summaryeltcalc_P6 > work/kat/il_S1_eltcalc_P6 & pid31=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/il_S1_summarysummarycalc_P6 > work/kat/il_S1_summarycalc_P6 & pid32=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/il_S1_summarypltcalc_P6 > work/kat/il_S1_pltcalc_P6 & pid33=$!
eltcalc -s < /tmp/%FIFO_DIR%/fifo/il_S2_summaryeltcalc_P6 > work/kat/il_S2_eltcalc_P6 & pid34=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/il_S2_summarysummarycalc_P6 > work/kat/il_S2_summarycalc_P6 & pid35=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/il_S2_summarypltcalc_P6 > work/kat/il_S2_pltcalc_P6 & pid36=$!
eltcalc -s < /tmp/%FIFO_DIR%/fifo/il_S1_summaryeltcalc_P7 > work/kat/il_S1_eltcalc_P7 & pid37=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/il_S1_summarysummarycalc_P7 > work/kat/il_S1_summarycalc_P7 & pid38=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/il_S1_summarypltcalc_P7 > work/kat/il_S1_pltcalc_P7 & pid39=$!
eltcalc -s < /tmp/%FIFO_DIR%/fifo/il_S2_summaryeltcalc_P7 > work/kat/il_S2_eltcalc_P7 & pid40=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/il_S2_summarysummarycalc_P7 > work/kat/il_S2_summarycalc_P7 & pid41=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/il_S2_summarypltcalc_P7 > work/kat/il_S2_pltcalc_P7 & pid42=$!
eltcalc -s < /tmp/%FIFO_DIR%/fifo/il_S1_summaryeltcalc_P8 > work/kat/il_S1_eltcalc_P8 & pid43=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/il_S1_summarysummarycalc_P8 > work/kat/il_S1_summarycalc_P8 & pid44=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/il_S1_summarypltcalc_P8 > work/kat/il_S1_pltcalc_P8 & pid45=$!
eltcalc -s < /tmp/%FIFO_DIR%/fifo/il_S2_summaryeltcalc_P8 > work/kat/il_S2_eltcalc_P8 & pid46=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/il_S2_summarysummarycalc_P8 > work/kat/il_S2_summarycalc_P8 & pid47=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/il_S2_summarypltcalc_P8 > work/kat/il_S2_pltcalc_P8 & pid48=$!
eltcalc -s < /tmp/%FIFO_DIR%/fifo/il_S1_summaryeltcalc_P9 > work/kat/il_S1_eltcalc_P9 & pid49=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/il_S1_summarysummarycalc_P9 > work/kat/il_S1_summarycalc_P9 & pid50=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/il_S1_summarypltcalc_P9 > work/kat/il_S1_pltcalc_P9 & pid51=$!
eltcalc -s < /tmp/%FIFO_DIR%/fifo/il_S2_summaryeltcalc_P9 > work/kat/il_S2_eltcalc_P9 & pid52=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/il_S2_summarysummarycalc_P9 > work/kat/il_S2_summarycalc_P9 & pid53=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/il_S2_summarypltcalc_P9 > work/kat/il_S2_pltcalc_P9 & pid54=$!
eltcalc -s < /tmp/%FIFO_DIR%/fifo/il_S1_summaryeltcalc_P10 > work/kat/il_S1_eltcalc_P10 & pid55=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/il_S1_summarysummarycalc_P10 > work/kat/il_S1_summarycalc_P10 & pid56=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/il_S1_summarypltcalc_P10 > work/kat/il_S1_pltcalc_P10 & pid57=$!
eltcalc -s < /tmp/%FIFO_DIR%/fifo/il_S2_summaryeltcalc_P10 > work/kat/il_S2_eltcalc_P10 & pid58=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/il_S2_summarysummarycalc_P10 > work/kat/il_S2_summarycalc_P10 & pid59=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/il_S2_summarypltcalc_P10 > work/kat/il_S2_pltcalc_P10 & pid60=$!
...
tee < /tmp/%FIFO_DIR%/fifo/il_S2_summary_P1 /tmp/%FIFO_DIR%/fifo/il_S2_summaryeltcalc_P1 /tmp/%FIFO_DIR%/fifo/il_S2_summarypltcalc_P1 /tmp/%FIFO_DIR%/fifo/il_S2_summarysummarycalc_P1 work/il_S2_summaryaalcalc/P1.bin work/il_S2_summaryleccalc/P1.bin > /dev/null & pid62=$!
tee < /tmp/%FIFO_DIR%/fifo/il_S1_summary_P2 /tmp/%FIFO_DIR%/fifo/il_S1_summaryeltcalc_P2 /tmp/%FIFO_DIR%/fifo/il_S1_summarypltcalc_P2 /tmp/%FIFO_DIR%/fifo/il_S1_summarysummarycalc_P2 work/il_S1_summaryaalcalc/P2.bin work/il_S1_summaryleccalc/P2.bin > /dev/null & pid63=$!
tee < /tmp/%FIFO_DIR%/fifo/il_S2_summary_P2 /tmp/%FIFO_DIR%/fifo/il_S2_summaryeltcalc_P2 /tmp/%FIFO_DIR%/fifo/il_S2_summarypltcalc_P2 /tmp/%FIFO_DIR%/fifo/il_S2_summarysummarycalc_P2 work/il_S2_summaryaalcalc/P2.bin work/il_S2_summaryleccalc/P2.bin > /dev/null & pid64=$!
tee < /tmp/%FIFO_DIR%/fifo/il_S1_summary_P3 /tmp/%FIFO_DIR%/fifo/il_S1_summaryeltcalc_P3 /tmp/%FIFO_DIR%/fifo/il_S1_summarypltcalc_P3 /tmp/%FIFO_DIR%/fifo/il_S1_summarysummarycalc_P3 work/il_S1_summaryaalcalc/P3.bin work/il_S1_summaryleccalc/P3.bin > /dev/null & pid65=$!
tee < /tmp/%FIFO_DIR%/fifo/il_S2_summary_P3 /tmp/%FIFO_DIR%/fifo/il_S2_summaryeltcalc_P3 /tmp/%FIFO_DIR%/fifo/il_S2_summarypltcalc_P3 /tmp/%FIFO_DIR%/fifo/il_S2_summarysummarycalc_P3 work/il_S2_summaryaalcalc/P3.bin work/il_S2_summaryleccalc/P3.bin > /dev/null & pid66=$!
tee < /tmp/%FIFO_DIR%/fifo/il_S1_summary_P4 /tmp/%FIFO_DIR%/fifo/il_S1_summaryeltcalc_P4 /tmp/%FIFO_DIR%/fifo/il_S1_summarypltcalc_P4 /tmp/%FIFO_DIR%/fifo/il_S1_summarysummarycalc_P4 work/il_S1_summaryaalcalc/P4.bin work/il_S1_summaryleccalc/P4.bin > /dev/null & pid67=$!
tee < /tmp/%FIFO_DIR%/fifo/il_S2_summary_P4 /tmp/%FIFO_DIR%/fifo/il_S2_summaryeltcalc_P4 /tmp/%FIFO_DIR%/fifo/il_S2_summarypltcalc_P4 /tmp/%FIFO_DIR%/fifo/il_S2_summarysummarycalc_P4 work/il_S2_summaryaalcalc/P4.bin work/il_S2_summaryleccalc/P4.bin > /dev/null & pid68=$!
tee < /tmp/%FIFO_DIR%/fifo/il_S1_summary_P5 /tmp/%FIFO_DIR%/fifo/il_S1_summaryeltcalc_P5 /tmp/%FIFO_DIR%/fifo/il_S1_summarypltcalc_P5 /tmp/%FIFO_DIR%/fifo/il_S1_summarysummarycalc_P5 work/il_S1_summaryaalcalc/P5.bin work/il_S1_summaryleccalc/P5.bin > /dev/null & pid69=$!
tee < /tmp/%FIFO_DIR%/fifo/il_S2_summary_P5 /tmp/%FIFO_DIR%/fifo/il_S2_summaryeltcalc_P5 /tmp/%FIFO_DIR%/fifo/il_S2_summarypltcalc_P5 /tmp/%FIFO_DIR%/fifo/il_S2_summarysummarycalc_P5 work/il_S2_summaryaalcalc/P5.bin work/il_S2_summaryleccalc/P5.bin > /dev/null & pid70=$!
tee < /tmp/%FIFO_DIR%/fifo/il_S1_summary_P6 /tmp/%FIFO_DIR%/fifo/il_S1_summaryeltcalc_P6 /tmp/%FIFO_DIR%/fifo/il_S1_summarypltcalc_P6 /tmp/%FIFO_DIR%/fifo/il_S1_summarysummarycalc_P6 work/il_S1_summaryaalcalc/P6.bin work/il_S1_summaryleccalc/P6.bin > /dev/null & pid71=$!
tee < /tmp/%FIFO_DIR%/fifo/il_S2_summary_P6 /tmp/%FIFO_DIR%/fifo/il_S2_summaryeltcalc_P6 /tmp/%FIFO_DIR%/fifo/il_S2_summarypltcalc_P6 /tmp/%FIFO_DIR%/fifo/il_S2_summarysummarycalc_P6 work/il_S2_summaryaalcalc/P6.bin work/il_S2_summaryleccalc/P6.bin > /dev/null & pid72=$!
tee < /tmp/%FIFO_DIR%/fifo/il_S1_summary_P7 /tmp/%FIFO_DIR%/fifo/il_S1_summaryeltcalc_P7 /tmp/%FIFO_DIR%/fifo/il_S1_summarypltcalc_P7 /tmp/%FIFO_DIR%/fifo/il_S1_summarysummarycalc_P7 work/il_S1_summaryaalcalc/P7.bin work/il_S1_summaryleccalc/P7.bin > /dev/null & pid73=$!
tee < /tmp/%FIFO_DIR%/fifo/il_S2_summary_P7 /tmp/%FIFO_DIR%/fifo/il_S2_summaryeltcalc_P7 /tmp/%FIFO_DIR%/fifo/il_S2_summarypltcalc_P7 /tmp/%FIFO_DIR%/fifo/il_S2_summarysummarycalc_P7 work/il_S2_summaryaalcalc/P7.bin work/il_S2_summaryleccalc/P7.bin > /dev/null & pid74=$!
tee < /tmp/%FIFO_DIR%/fifo/il_S1_summary_P8 /tmp/%FIFO_DIR%/fifo/il_S1_summaryeltcalc_P8 /tmp/%FIFO_DIR%/fifo/il_S1_summarypltcalc_P8 /tmp/%FIFO_DIR%/fifo/il_S1_summarysummarycalc_P8 work/il_S1_summaryaalcalc/P8.bin work/il_S1_summaryleccalc/P8.bin > /dev/null & pid75=$!
tee < /tmp/%FIFO_DIR%/fifo/il_S2_summary_P8 /tmp/%FIFO_DIR%/fifo/il_S2_summaryeltcalc_P8 /tmp/%FIFO_DIR%/fifo/il_S2_summarypltcalc_P8 /tmp/%FIFO_DIR%/fifo/il_S2_summarysummarycalc_P8 work/il_S2_summaryaalcalc/P8.bin work/il_S2_summaryleccalc/P8.bin > /dev/null & pid76=$!
tee < /tmp/%FIFO_DIR%/fifo/il_S1_summary_P9 /tmp/%FIFO_DIR%/fifo/il_S1_summaryeltcalc_P9 /tmp/%FIFO_DIR%/fifo/il_S1_summarypltcalc_P9 /tmp/%FIFO_DIR%/fifo/il_S1_summarysummarycalc_P9 work/il_S1_summaryaalcalc/P9.bin work/il_S1_summaryleccalc/P9.bin > /dev/null & pid77=$!
tee < /tmp/%FIFO_DIR%/fifo/il_S2_summary_P9 /tmp/%FIFO_DIR%/fifo/il_S2_summaryeltcalc_P9 /tmp/%FIFO_DIR%/fifo/il_S2_summarypltcalc_P9 /tmp/%FIFO_DIR%/fifo/il_S2_summarysummarycalc_P9 work/il_S2_summaryaalcalc/P9.bin work/il_S2_summaryleccalc/P9.bin > /dev/null & pid78=$!
tee < /tmp/%FIFO_DIR%/fifo/il_S1_summary_P10 /tmp/%FIFO_DIR%/fifo/il_S1_summaryeltcalc_P10 /tmp/%FIFO_DIR%/fifo/il_S1_summarypltcalc_P10 /tmp/%FIFO_DIR%/fifo/il_S1_summarysummarycalc_P10 work/il_S1_summaryaalcalc/P10.bin work/il_S1_summaryleccalc/P10.bin > /dev/null & pid79=$!
tee < /tmp/%FIFO_DIR%/fifo/il_S2_summary_P10 /tmp/%FIFO_DIR%/fifo/il_S2_summaryeltcalc_P10 /tmp/%FIFO_DIR%/fifo/il_S2_summarypltcalc_P10 /tmp/%FIFO_DIR%/fifo/il_S2_summarysummarycalc_P10 work/il_S2_summaryaalcalc/P10.bin work/il_S2_summaryleccalc/P10.bin > /dev/null & pid80=$!
...
eltcalc < /tmp/%FIFO_DIR%/fifo/gul_S2_summaryeltcalc_P1 > work/kat/gul_S2_eltcalc_P1 & pid84=$!
summarycalctocsv < /tmp/%FIFO_DIR%/fifo/gul_S2_summarysummarycalc_P1 > work/kat/gul_S2_summarycalc_P1 & pid85=$!
pltcalc < /tmp/%FIFO_DIR%/fifo/gul_S2_summarypltcalc_P1 > work/kat/gul_S2_pltcalc_P1 & pid86=$!
eltcalc -s < /tmp/%FIFO_DIR%/fifo/gul_S1_summaryeltcalc_P2 > work/kat/gul_S1_eltcalc_P2 & pid87=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/gul_S1_summarysummarycalc_P2 > work/kat/gul_S1_summarycalc_P2 & pid88=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/gul_S1_summarypltcalc_P2 > work/kat/gul_S1_pltcalc_P2 & pid89=$!
eltcalc -s < /tmp/%FIFO_DIR%/fifo/gul_S2_summaryeltcalc_P2 > work/kat/gul_S2_eltcalc_P2 & pid90=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/gul_S2_summarysummarycalc_P2 > work/kat/gul_S2_summarycalc_P2 & pid91=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/gul_S2_summarypltcalc_P2 > work/kat/gul_S2_pltcalc_P2 & pid92=$!
eltcalc -s < /tmp/%FIFO_DIR%/fifo/gul_S1_summaryeltcalc_P3 > work/kat/gul_S1_eltcalc_P3 & pid93=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/gul_S1_summarysummarycalc_P3 > work/kat/gul_S1_summarycalc_P3 & pid94=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/gul_S1_summarypltcalc_P3 > work/kat/gul_S1_pltcalc_P3 & pid95=$!
eltcalc -s < /tmp/%FIFO_DIR%/fifo/gul_S2_summaryeltcalc_P3 > work/kat/gul_S2_eltcalc_P3 & pid96=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/gul_S2_summarysummarycalc_P3 > work/kat/gul_S2_summarycalc_P3 & pid97=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/gul_S2_summarypltcalc_P3 > work/kat/gul_S2_pltcalc_P3 & pid98=$!
eltcalc -s < /tmp/%FIFO_DIR%/fifo/gul_S1_summaryeltcalc_P4 > work/kat/gul_S1_eltcalc_P4 & pid99=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/gul_S1_summarysummarycalc_P4 > work/kat/gul_S1_summarycalc_P4 & pid100=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/gul_S1_summarypltcalc_P4 > work/kat/gul_S1_pltcalc_P4 & pid101=$!
eltcalc -s < /tmp/%FIFO_DIR%/fifo/gul_S2_summaryeltcalc_P4 > work/kat/gul_S2_eltcalc_P4 & pid102=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/gul_S2_summarysummarycalc_P4 > work/kat/gul_S2_summarycalc_P4 & pid103=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/gul_S2_summarypltcalc_P4 > work/kat/gul_S2_pltcalc_P4 & pid104=$!
eltcalc -s < /tmp/%FIFO_DIR%/fifo/gul_S1_summaryeltcalc_P5 > work/kat/gul_S1_eltcalc_P5 & pid105=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/gul_S1_summarysummarycalc_P5 > work/kat/gul_S1_summarycalc_P5 & pid106=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/gul_S1_summarypltcalc_P5 > work/kat/gul_S1_pltcalc_P5 & pid107=$!
eltcalc -s < /tmp/%FIFO_DIR%/fifo/gul_S2_summaryeltcalc_P5 > work/kat/gul_S2_eltcalc_P5 & pid108=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/gul_S2_summarysummarycalc_P5 > work/kat/gul_S2_summarycalc_P5 & pid109=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/gul_S2_summarypltcalc_P5 > work/kat/gul_S2_pltcalc_P5 & pid110=$!
eltcalc -s < /tmp/%FIFO_DIR%/fifo/gul_S1_summaryeltcalc_P6 > work/kat/gul_S1_eltcalc_P6 & pid111=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/gul_S1_summarysummarycalc_P6 > work/kat/gul_S1_summarycalc_P6 & pid112=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/gul_S1_summarypltcalc_P6 > work/kat/gul_S1_pltcalc_P6 & pid113=$!
eltcalc -s < /tmp/%FIFO_DIR%/fifo/gul_S2_summaryeltcalc_P6 > work/kat/gul_S2_eltcalc_P6 & pid114=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/gul_S2_summarysummarycalc_P6 > work/kat/gul_S2_summarycalc_P6 & pid115=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/gul_S2_summarypltcalc_P6 > work/kat/gul_S2_pltcalc_P6 & pid116=$!
eltcalc -s < /tmp/%FIFO_DIR%/fifo/gul_S1_summaryeltcalc_P7 > work/kat/gul_S1_eltcalc_P7 & pid117=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/gul_S1_summarysummarycalc_P7 > work/kat/gul_S1_summarycalc_P7 & pid118=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/gul_S1_summarypltcalc_P7 > work/kat/gul_S1_pltcalc_P7 & pid119=$!
eltcalc -s < /tmp/%FIFO_DIR%/fifo/gul_S2_summaryeltcalc_P7 > work/kat/gul_S2_eltcalc_P7 & pid120=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/gul_S2_summarysummarycalc_P7 > work/kat/gul_S2_summarycalc_P7 & pid121=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/gul_S2_summarypltcalc_P7 > work/kat/gul_S2_pltcalc_P7 & pid122=$!
eltcalc -s < /tmp/%FIFO_DIR%/fifo/gul_S1_summaryeltcalc_P8 > work/kat/gul_S1_eltcalc_P8 & pid123=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/gul_S1_summarysummarycalc_P8 > work/kat/gul_S1_summarycalc_P8 & pid124=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/gul_S1_summarypltcalc_P8 > work/kat/gul_S1_pltcalc_P8 & pid125=$!
eltcalc -s < /tmp/%FIFO_DIR%/fifo/gul_S2_summaryeltcalc_P8 > work/kat/gul_S2_eltcalc_P8 & pid126=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/gul_S2_summarysummarycalc_P8 > work/kat/gul_S2_summarycalc_P8 & pid127=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/gul_S2_summarypltcalc_P8 > work/kat/gul_S2_pltcalc_P8 & pid128=$!
eltcalc -s < /tmp/%FIFO_DIR%/fifo/gul_S1_summaryeltcalc_P9 > work/kat/gul_S1_eltcalc_P9 & pid129=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/gul_S1_summarysummarycalc_P9 > work/kat/gul_S1_summarycalc_P9 & pid130=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/gul_S1_summarypltcalc_P9 > work/kat/gul_S1_pltcalc_P9 & pid131=$!
eltcalc -s < /tmp/%FIFO_DIR%/fifo/gul_S2_summaryeltcalc_P9 > work/kat/gul_S2_eltcalc_P9 & pid132=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/gul_S2_summarysummarycalc_P9 > work/kat/gul_S2_summarycalc_P9 & pid133=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/gul_S2_summarypltcalc_P9 > work/kat/gul_S2_pltcalc_P9 & pid134=$!
eltcalc -s < /tmp/%FIFO_DIR%/fifo/gul_S1_summaryeltcalc_P10 > work/kat/gul_S1_eltcalc_P10 & pid135=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/gul_S1_summarysummarycalc_P10 > work/kat/gul_S1_summarycalc_P10 & pid136=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/gul_S1_summarypltcalc_P10 > work/kat/gul_S1_pltcalc_P10 & pid137=$!
eltcalc -s < /tmp/%FIFO_DIR%/fifo/gul_S2_summaryeltcalc_P10 > work/kat/gul_S2_eltcalc_P10 & pid138=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/gul_S2_summarysummarycalc_P10 > work/kat/gul_S2_summarycalc_P10 & pid139=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/gul_S2_summarypltcalc_P10 > work/kat/gul_S2_pltcalc_P10 & pid140=$!
...
tee < /tmp/%FIFO_DIR%/fifo/gul_S2_summary_P1 /tmp/%FIFO_DIR%/fifo/gul_S2_summaryeltcalc_P1 /tmp/%FIFO_DIR%/fifo/gul_S2_summarypltcalc_P1 /tmp/%FIFO_DIR%/fifo/gul_S2_summarysummarycalc_P1 work/gul_S2_summaryaalcalc/P1.bin work/gul_S2_summaryleccalc/P1.bin > /dev/null & pid142=$!
tee < /tmp/%FIFO_DIR%/fifo/gul_S1_summary_P2 /tmp/%FIFO_DIR%/fifo/gul_S1_summaryeltcalc_P2 /tmp/%FIFO_DIR%/fifo/gul_S1_summarypltcalc_P2 /tmp/%FIFO_DIR%/fifo/gul_S1_summarysummarycalc_P2 work/gul_S1_summaryaalcalc/P2.bin work/gul_S1_summaryleccalc/P2.bin > /dev/null & pid143=$!
tee < /tmp/%FIFO_DIR%/fifo/gul_S2_summary_P2 /tmp/%FIFO_DIR%/fifo/gul_S2_summaryeltcalc_P2 /tmp/%FIFO_DIR%/fifo/gul_S2_summarypltcalc_P2 /tmp/%FIFO_DIR%/fifo/gul_S2_summarysummarycalc_P2 work/gul_S2_summaryaalcalc/P2.bin work/gul_S2_summaryleccalc/P2.bin > /dev/null & pid144=$!
tee < /tmp/%FIFO_DIR%/fifo/gul_S1_summary_P3 /tmp/%FIFO_DIR%/fifo/gul_S1_summaryeltcalc_P3 /tmp/%FIFO_DIR%/fifo/gul_S1_summarypltcalc_P3 /tmp/%FIFO_DIR%/fifo/gul_S1_summarysummarycalc_P3 work/gul_S1_summaryaalcalc/P3.bin work/gul_S1_summaryleccalc/P3.bin > /dev/null & pid145=$!
tee < /tmp/%FIFO_DIR%/fifo/gul_S2_summary_P3 /tmp/%FIFO_DIR%/fifo/gul_S2_summaryeltcalc_P3 /tmp/%FIFO_DIR%/fifo/gul_S2_summarypltcalc_P3 /tmp/%FIFO_DIR%/fifo/gul_S2_summarysummarycalc_P3 work/gul_S2_summaryaalcalc/P3.bin work/gul_S2_summaryleccalc/P3.bin > /dev/null & pid146=$!
tee < /tmp/%FIFO_DIR%/fifo/gul_S1_summary_P4 /tmp/%FIFO_DIR%/fifo/gul_S1_summaryeltcalc_P4 /tmp/%FIFO_DIR%/fifo/gul_S1_summarypltcalc_P4 /tmp/%FIFO_DIR%/fifo/gul_S1_summarysummarycalc_P4 work/gul_S1_summaryaalcalc/P4.bin work/gul_S1_summaryleccalc/P4.bin > /dev/null & pid147=$!
tee < /tmp/%FIFO_DIR%/fifo/gul_S2_summary_P4 /tmp/%FIFO_DIR%/fifo/gul_S2_summaryeltcalc_P4 /tmp/%FIFO_DIR%/fifo/gul_S2_summarypltcalc_P4 /tmp/%FIFO_DIR%/fifo/gul_S2_summarysummarycalc_P4 work/gul_S2_summaryaalcalc/P4.bin work/gul_S2_summaryleccalc/P4.bin > /dev/null & pid148=$!
tee < /tmp/%FIFO_DIR%/fifo/gul_S1_summary_P5 /tmp/%FIFO_DIR%/fifo/gul_S1_summaryeltcalc_P5 /tmp/%FIFO_DIR%/fifo/gul_S1_summarypltcalc_P5 /tmp/%FIFO_DIR%/fifo/gul_S1_summarysummarycalc_P5 work/gul_S1_summaryaalcalc/P5.bin work/gul_S1_summaryleccalc/P5.bin > /dev/null & pid149=$!
tee < /tmp/%FIFO_DIR%/fifo/gul_S2_summary_P5 /tmp/%FIFO_DIR%/fifo/gul_S2_summaryeltcalc_P5 /tmp/%FIFO_DIR%/fifo/gul_S2_summarypltcalc_P5 /tmp/%FIFO_DIR%/fifo/gul_S2_summarysummarycalc_P5 work/gul_S2_summaryaalcalc/P5.bin work/gul_S2_summaryleccalc/P5.bin > /dev/null & pid150=$!
tee < /tmp/%FIFO_DIR%/fifo/gul_S1_summary_P6 /tmp/%FIFO_DIR%/fifo/gul_S1_summaryeltcalc_P6 /tmp/%FIFO_DIR%/fifo/gul_S1_summarypltcalc_P6 /tmp/%FIFO_DIR%/fifo/gul_S1_summarysummarycalc_P6 work/gul_S1_summaryaalcalc/P6.bin work/gul_S1_summaryleccalc/P6.bin > /dev/null & pid151=$!
tee < /tmp/%FIFO_DIR%/fifo/gul_S2_summary_P6 /tmp/%FIFO_DIR%/fifo/gul_S2_summaryeltcalc_P6 /tmp/%FIFO_DIR%/fifo/gul_S2_summarypltcalc_P6 /tmp/%FIFO_DIR%/fifo/gul_S2_summarysummarycalc_P6 work/gul_S2_summaryaalcalc/P6.bin work/gul_S2_summaryleccalc/P6.bin > /dev/null & pid152=$!
tee < /tmp/%FIFO_DIR%/fifo/gul_S1_summary_P7 /tmp/%FIFO_DIR%/fifo/gul_S1_summaryeltcalc_P7 /tmp/%FIFO_DIR%/fifo/gul_S1_summarypltcalc_P7 /tmp/%FIFO_DIR%/fifo/gul_S1_summarysummarycalc_P7 work/gul_S1_summaryaalcalc/P7.bin work/gul_S1_summaryleccalc/P7.bin > /dev/null & pid153=$!
tee < /tmp/%FIFO_DIR%/fifo/gul_S2_summary_P7 /tmp/%FIFO_DIR%/fifo/gul_S2_summaryeltcalc_P7 /tmp/%FIFO_DIR%/fifo/gul_S2_summarypltcalc_P7 /tmp/%FIFO_DIR%/fifo/gul_S2_summarysummarycalc_P7 work/gul_S2_summaryaalcalc/P7.bin work/gul_S2_summaryleccalc/P7.bin > /dev/null & pid154=$!
tee < /tmp/%FIFO_DIR%/fifo/gul_S1_summary_P8 /tmp/%FIFO_DIR%/fifo/gul_S1_summaryeltcalc_P8 /tmp/%FIFO_DIR%/fifo/gul_S1_summarypltcalc_P8 /tmp/%FIFO_DIR%/fifo/gul_S1_summarysummarycalc_P8 work/gul_S1_summaryaalcalc/P8.bin work/gul_S1_summaryleccalc/P8.bin > /dev/null & pid155=$!
tee < /tmp/%FIFO_DIR%/fifo/gul_S2_summary_P8 /tmp/%FIFO_DIR%/fifo/gul_S2_summaryeltcalc_P8 /tmp/%FIFO_DIR%/fifo/gul_S2_summarypltcalc_P8 /tmp/%FIFO_DIR%/fifo/gul_S2_summarysummarycalc_P8 work/gul_S2_summaryaalcalc/P8.bin work/gul_S2_summaryleccalc/P8.bin > /dev/null & pid156=$!
tee < /tmp/%FIFO_DIR%/fifo/gul_S1_summary_P9 /tmp/%FIFO_DIR%/fifo/gul_S1_summaryeltcalc_P9 /tmp/%FIFO_DIR%/fifo/gul_S1_summarypltcalc_P9 /tmp/%FIFO_DIR%/fifo/gul_S1_summarysummarycalc_P9 work/gul_S1_summaryaalcalc/P9.bin work/gul_S1_summaryleccalc/P9.bin > /dev/null & pid157=$!
tee < /tmp/%FIFO_DIR%/fifo/gul_S2_summary_P9 /tmp/%FIFO_DIR%/fifo/gul_S2_summaryeltcalc_P9 /tmp/%FIFO_DIR%/fifo/gul_S2_summarypltcalc_P9 /tmp/%FIFO_DIR%/fifo/gul_S2_summarysummarycalc_P9 work/gul_S2_summaryaalcalc/P9.bin work/gul_S2_summaryleccalc/P9.bin > /dev/null & pid158=$!
tee < /tmp/%FIFO_DIR%/fifo/gul_S1_summary_P10 /tmp/%FIFO_DIR%/fifo/gul_S1_summaryeltcalc_P10 /tmp/%FIFO_DIR%/fifo/gul_S1_summarypltcalc_P10 /tmp/%FIFO_DIR%/fifo/gul_S1_summarysummarycalc_P10 work/gul_S1_summaryaalcalc/P10.bin work/gul_S1_summaryleccalc/P10.bin > /dev/null & pid159=$!
tee < /tmp/%FIFO_DIR%/fifo/gul_S2_summary_P10 /tmp/%FIFO_DIR%/fifo/gul_S2_summaryeltcalc_P10 /tmp/%FIFO_DIR%/fifo/gul_S2_summarypltcalc_P10 /tmp/%FIFO_DIR%/fifo/gul_S2_summarysummarycalc_P10 work/gul_S2_summaryaalcalc/P10.bin work/gul_S2_summaryleccalc/P10.bin > /dev/null & pid160=$!
...
eve 1 10 | getmodel | gulcalc -S0 -L0 -r -j /tmp/%FIFO_DIR%/fifo/full_correlation/gul_P1 -a1 -i - | tee /tmp/%FIFO_DIR%/fifo/gul_P1 | fmcalc -a2 > /tmp/%FIFO_DIR%/fifo/il_P1  &
eve 2 10 | getmodel | gulcalc -S0 -L0 -r -j /tmp/%FIFO_DIR%/fifo/full_correlation/gul_P2 -a1 -i - | tee /tmp/%FIFO_DIR%/fifo/gul_P2 | fmcalc -a2 > /tmp/%FIFO_DIR%/fifo/il_P2  &
eve 3 10 | getmodel | gulcalc -S0 -L0 -r -j /tmp/%FIFO_DIR%/fifo/full_correlation/gul_P3 -a1 -i - | tee /tmp/%FIFO_DIR%/fifo/gul_P3 | fmcalc -a2 > /tmp/%FIFO_DIR%/fifo/il_P3  &
eve 4 10 | getmodel | gulcalc -S0 -L0 -r -j /tmp/%FIFO_DIR%/fifo/full_correlation/gul_P4 -a1 -i - | tee /tmp/%FIFO_DIR%/fifo/gul_P4 | fmcalc -a2 > /tmp/%FIFO_DIR%/fifo/il_P4  &
eve 5 10 | getmodel | gulcalc -S0 -L0 -r -j /tmp/%FIFO_DIR%/fifo/full_correlation/gul_P5 -a1 -i - | tee /tmp/%FIFO_DIR%/fifo/gul_P5 | fmcalc -a2 > /tmp/%FIFO_DIR%/fifo/il_P5  &
eve 6 10 | getmodel | gulcalc -S0 -L0 -r -j /tmp/%FIFO_DIR%/fifo/full_correlation/gul_P6 -a1 -i - | tee /tmp/%FIFO_DIR%/fifo/gul_P6 | fmcalc -a2 > /tmp/%FIFO_DIR%/fifo/il_P6  &
eve 7 10 | getmodel | gulcalc -S0 -L0 -r -j /tmp/%FIFO_DIR%/fifo/full_correlation/gul_P7 -a1 -i - | tee /tmp/%FIFO_DIR%/fifo/gul_P7 | fmcalc -a2 > /tmp/%FIFO_DIR%/fifo/il_P7  &
eve 8 10 | getmodel | gulcalc -S0 -L0 -r -j /tmp/%FIFO_DIR%/fifo/full_correlation/gul_P8 -a1 -i - | tee /tmp/%FIFO_DIR%/fifo/gul_P8 | fmcalc -a2 > /tmp/%FIFO_DIR%/fifo/il_P8  &
eve 9 10 | getmodel | gulcalc -S0 -L0 -r -j /tmp/%FIFO_DIR%/fifo/full_correlation/gul_P9 -a1 -i - | tee /tmp/%FIFO_DIR%/fifo/gul_P9 | fmcalc -a2 > /tmp/%FIFO_DIR%/fifo/il_P9  &
eve 10 10 | getmodel | gulcalc -S0 -L0 -r -j /tmp/%FIFO_DIR%/fifo/full_correlation/gul_P10 -a1 -i - | tee /tmp/%FIFO_DIR%/fifo/gul_P10 | fmcalc -a2 > /tmp/%FIFO_DIR%/fifo/il_P10  &
...
eltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_summaryeltcalc_P3 > work/full_correlation/kat/il_S1_eltcalc_P3 & pid13=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_summarysummarycalc_P3 > work/full_correlation/kat/il_S1_summarycalc_P3 & pid14=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_summarypltcalc_P3 > work/full_correlation/kat/il_S1_pltcalc_P3 & pid15=$!
eltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summaryeltcalc_P3 > work/full_correlation/kat/il_S2_eltcalc_P3 & pid16=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summarysummarycalc_P3 > work/full_correlation/kat/il_S2_summarycalc_P3 & pid17=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summarypltcalc_P3 > work/full_correlation/kat/il_S2_pltcalc_P3 & pid18=$!
eltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_summaryeltcalc_P4 > work/full_correlation/kat/il_S1_eltcalc_P4 & pid19=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_summarysummarycalc_P4 > work/full_correlation/kat/il_S1_summarycalc_P4 & pid20=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_summarypltcalc_P4 > work/full_correlation/kat/il_S1_pltcalc_P4 & pid21=$!
eltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summaryeltcalc_P4 > work/full_correlation/kat/il_S2_eltcalc_P4 & pid22=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summarysummarycalc_P4 > work/full_correlation/kat/il_S2_summarycalc_P4 & pid23=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summarypltcalc_P4 > work/full_correlation/kat/il_S2_pltcalc_P4 & pid24=$!
eltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_summaryeltcalc_P5 > work/full_correlation/kat/il_S1_eltcalc_P5 & pid25=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_summarysummarycalc_P5 > work/full_correlation/kat/il_S1_summarycalc_P5 & pid26=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_summarypltcalc_P5 > work/full_correlation/kat/il_S1_pltcalc_P5 & pid27=$!
eltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summaryeltcalc_P5 > work/full_correlation/kat/il_S2_eltcalc_P5 & pid28=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summarysummarycalc_P5 > work/full_correlation/kat/il_S2_summarycalc_P5 & pid29=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summarypltcalc_P5 > work/full_correlation/kat/il_S2_pltcalc_P5 & pid30=$!
eltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_summaryeltcalc_P6 > work/full_correlation/kat/il_S1_eltcalc_P6 & pid31=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_summarysummarycalc_P6 > work/full_correlation/kat/il_S1_summarycalc_P6 & pid32=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_summarypltcalc_P6 > work/full_correlation/kat/il_S1_pltcalc_P6 & pid33=$!
eltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summaryeltcalc_P6 > work/full_correlation/kat/il_S2_eltcalc_P6 & pid34=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summarysummarycalc_P6 > work/full_correlation/kat/il_S2_summarycalc_P6 & pid35=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summarypltcalc_P6 > work/full_correlation/kat/il_S2_pltcalc_P6 & pid36=$!
eltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_summaryeltcalc_P7 > work/full_correlation/kat/il_S1_eltcalc_P7 & pid37=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_summarysummarycalc_P7 > work/full_correlation/kat/il_S1_summarycalc_P7 & pid38=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_summarypltcalc_P7 > work/full_correlation/kat/il_S1_pltcalc_P7 & pid39=$!
eltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summaryeltcalc_P7 > work/full_correlation/kat/il_S2_eltcalc_P7 & pid40=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summarysummarycalc_P7 > work/full_correlation/kat/il_S2_summarycalc_P7 & pid41=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summarypltcalc_P7 > work/full_correlation/kat/il_S2_pltcalc_P7 & pid42=$!
eltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_summaryeltcalc_P8 > work/full_correlation/kat/il_S1_eltcalc_P8 & pid43=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_summarysummarycalc_P8 > work/full_correlation/kat/il_S1_summarycalc_P8 & pid44=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_summarypltcalc_P8 > work/full_correlation/kat/il_S1_pltcalc_P8 & pid45=$!
eltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summaryeltcalc_P8 > work/full_correlation/kat/il_S2_eltcalc_P8 & pid46=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summarysummarycalc_P8 > work/full_correlation/kat/il_S2_summarycalc_P8 & pid47=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summarypltcalc_P8 > work/full_correlation/kat/il_S2_pltcalc_P8 & pid48=$!
eltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_summaryeltcalc_P9 > work/full_correlation/kat/il_S1_eltcalc_P9 & pid49=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_summarysummarycalc_P9 > work/full_correlation/kat/il_S1_summarycalc_P9 & pid50=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_summarypltcalc_P9 > work/full_correlation/kat/il_S1_pltcalc_P9 & pid51=$!
eltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summaryeltcalc_P9 > work/full_correlation/kat/il_S2_eltcalc_P9 & pid52=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summarysummarycalc_P9 > work/full_correlation/kat/il_S2_summarycalc_P9 & pid53=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summarypltcalc_P9 > work/full_correlation/kat/il_S2_pltcalc_P9 & pid54=$!
eltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_summaryeltcalc_P10 > work/full_correlation/kat/il_S1_eltcalc_P10 & pid55=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_summarysummarycalc_P10 > work/full_correlation/kat/il_S1_summarycalc_P10 & pid56=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_summarypltcalc_P10 > work/full_correlation/kat/il_S1_pltcalc_P10 & pid57=$!
eltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summaryeltcalc_P10 > work/full_correlation/kat/il_S2_eltcalc_P10 & pid58=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summarysummarycalc_P10 > work/full_correlation/kat/il_S2_summarycalc_P10 & pid59=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summarypltcalc_P10 > work/full_correlation/kat/il_S2_pltcalc_P10 & pid60=$!
...
tee < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summary_P1 /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summaryeltcalc_P1 /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summarypltcalc_P1 /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summarysummarycalc_P1 work/full_correlation/il_S2_summaryaalcalc/P1.bin work/full_correlation/il_S2_summaryleccalc/P1.bin > /dev/null & pid62=$!
tee < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_summary_P2 /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_summaryeltcalc_P2 /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_summarypltcalc_P2 /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_summarysummarycalc_P2 work/full_correlation/il_S1_summaryaalcalc/P2.bin work/full_correlation/il_S1_summaryleccalc/P2.bin > /dev/null & pid63=$!
tee < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summary_P2 /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summaryeltcalc_P2 /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summarypltcalc_P2 /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summarysummarycalc_P2 work/full_correlation/il_S2_summaryaalcalc/P2.bin work/full_correlation/il_S2_summaryleccalc/P2.bin > /dev/null & pid64=$!
tee < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_summary_P3 /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_summaryeltcalc_P3 /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_summarypltcalc_P3 /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_summarysummarycalc_P3 work/full_correlation/il_S1_summaryaalcalc/P3.bin work/full_correlation/il_S1_summaryleccalc/P3.bin > /dev/null & pid65=$!
tee < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summary_P3 /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summaryeltcalc_P3 /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summarypltcalc_P3 /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summarysummarycalc_P3 work/full_correlation/il_S2_summaryaalcalc/P3.bin work/full_correlation/il_S2_summaryleccalc/P3.bin > /dev/null & pid66=$!
tee < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_summary_P4 /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_summaryeltcalc_P4 /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_summarypltcalc_P4 /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_summarysummarycalc_P4 work/full_correlation/il_S1_summaryaalcalc/P4.bin work/full_correlation/il_S1_summaryleccalc/P4.bin > /dev/null & pid67=$!
tee < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summary_P4 /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summaryeltcalc_P4 /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summarypltcalc_P4 /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summarysummarycalc_P4 work/full_correlation/il_S2_summaryaalcalc/P4.bin work/full_correlation/il_S2_summaryleccalc/P4.bin > /dev/null & pid68=$!
...
tee < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summary_P5 /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summaryeltcalc_P5 /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summarypltcalc_P5 /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summarysummarycalc_P5 work/full_correlation/il_S2_summaryaalcalc/P5.bin work/full_correlation/il_S2_summaryleccalc/P5.bin > /dev/null & pid70=$!
tee < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_summary_P6 /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_summaryeltcalc_P6 /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_summarypltcalc_P6 /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_summarysummarycalc_P6 work/full_correlation/il_S1_summaryaalcalc/P6.bin work/full_correlation/il_S1_summaryleccalc/P6.bin > /dev/null & pid71=$!
tee < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summary_P6 /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summaryeltcalc_P6 /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summarypltcalc_P6 /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summarysummarycalc_P6 work/full_correlation/il_S2_summaryaalcalc/P6.bin work/full_correlation/il_S2_summaryleccalc/P6.bin > /dev/null & pid72=$!
tee < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_summary_P7 /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_summaryeltcalc_P7 /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_summarypltcalc_P7 /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_summarysummarycalc_P7 work/full_correlation/il_S1_summaryaalcalc/P7.bin work/full_correlation/il_S1_summaryleccalc/P7.bin > /dev/null & pid73=$!
tee < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summary_P7 /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summaryeltcalc_P7 /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summarypltcalc_P7 /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summarysummarycalc_P7 work/full_correlation/il_S2_summaryaalcalc/P7.bin work/full_correlation/il_S2_summaryleccalc/P7.bin > /dev/null & pid74=$!
tee < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_summary_P8 /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_summaryeltcalc_P8 /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_summarypltcalc_P8 /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_summarysummarycalc_P8 work/full_correlation/il_S1_summaryaalcalc/P8.bin work/full_correlation/il_S1_summaryleccalc/P8.bin > /dev/null & pid75=$!
tee < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summary_P8 /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summaryeltcalc_P8 /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summarypltcalc_P8 /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summarysummarycalc_P8 work/full_correlation/il_S2_summaryaalcalc/P8.bin work/full_correlation/il_S2_summaryleccalc/P8.bin > /dev/null & pid76=$!
tee < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_summary_P9 /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_summaryeltcalc_P9 /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_summarypltcalc_P9 /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_summarysummarycalc_P9 work/full_correlation/il_S1_summaryaalcalc/P9.bin work/full_correlation/il_S1_summaryleccalc/P9.bin > /dev/null & pid77=$!
tee < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summary_P9 /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summaryeltcalc_P9 /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summarypltcalc_P9 /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summarysummarycalc_P9 work/full_correlation/il_S2_summaryaalcalc/P9.bin work/full_correlation/il_S2_summaryleccalc/P9.bin > /dev/null & pid78=$!
tee < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_summary_P10 /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_summaryeltcalc_P10 /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_summarypltcalc_P10 /tmp/%FIFO_DIR%/fifo/full_correlation/il_S1_summarysummarycalc_P10 work/full_correlation/il_S1_summaryaalcalc/P10.bin work/full_correlation/il_S1_summaryleccalc/P10.bin > /dev/null & pid79=$!
tee < /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summary_P10 /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summaryeltcalc_P10 /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summarypltcalc_P10 /tmp/%FIFO_DIR%/fifo/full_correlation/il_S2_summarysummarycalc_P10 work/full_correlation/il_S2_summaryaalcalc/P10.bin work/full_correlation/il_S2_summaryleccalc/P10.bin > /dev/null & pid80=$!
...
eltcalc < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_summaryeltcalc_P1 > work/full_correlation/kat/gul_S1_eltcalc_P1 & pid81=$!
summarycalctocsv < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_summarysummarycalc_P1 > work/full_correlation/kat/gul_S1_summarycalc_P1 & pid82=$!
pltcalc < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_summarypltcalc_P1 > work/full_correlation/kat/gul_S1_pltcalc_P1 & pid83=$!
eltcalc < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summaryeltcalc_P1 > work/full_correlation/kat/gul_S2_eltcalc_P1 & pid84=$!
summarycalctocsv < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarysummarycalc_P1 > work/full_correlation/kat/gul_S2_summarycalc_P1 & pid85=$!
pltcalc < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarypltcalc_P1 > work/full_correlation/kat/gul_S2_pltcalc_P1 & pid86=$!
eltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_summaryeltcalc_P2 > work/full_correlation/kat/gul_S1_eltcalc_P2 & pid87=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_summarysummarycalc_P2 > work/full_correlation/kat/gul_S1_summarycalc_P2 & pid88=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_summarypltcalc_P2 > work/full_correlation/kat/gul_S1_pltcalc_P2 & pid89=$!
eltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summaryeltcalc_P2 > work/full_correlation/kat/gul_S2_eltcalc_P2 & pid90=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarysummarycalc_P2 > work/full_correlation/kat/gul_S2_summarycalc_P2 & pid91=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarypltcalc_P2 > work/full_correlation/kat/gul_S2_pltcalc_P2 & pid92=$!
eltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_summaryeltcalc_P3 > work/full_correlation/kat/gul_S1_eltcalc_P3 & pid93=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_summarysummarycalc_P3 > work/full_correlation/kat/gul_S1_summarycalc_P3 & pid94=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_summarypltcalc_P3 > work/full_correlation/kat/gul_S1_pltcalc_P3 & pid95=$!
eltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summaryeltcalc_P3 > work/full_correlation/kat/gul_S2_eltcalc_P3 & pid96=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarysummarycalc_P3 > work/full_correlation/kat/gul_S2_summarycalc_P3 & pid97=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarypltcalc_P3 > work/full_correlation/kat/gul_S2_pltcalc_P3 & pid98=$!
eltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_summaryeltcalc_P4 > work/full_correlation/kat/gul_S1_eltcalc_P4 & pid99=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_summarysummarycalc_P4 > work/full_correlation/kat/gul_S1_summarycalc_P4 & pid100=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_summarypltcalc_P4 > work/full_correlation/kat/gul_S1_pltcalc_P4 & pid101=$!
eltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summaryeltcalc_P4 > work/full_correlation/kat/gul_S2_eltcalc_P4 & pid102=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarysummarycalc_P4 > work/full_correlation/kat/gul_S2_summarycalc_P4 & pid103=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarypltcalc_P4 > work/full_correlation/kat/gul_S2_pltcalc_P4 & pid104=$!
eltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_summaryeltcalc_P5 > work/full_correlation/kat/gul_S1_eltcalc_P5 & pid105=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_summarysummarycalc_P5 > work/full_correlation/kat/gul_S1_summarycalc_P5 & pid106=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_summarypltcalc_P5 > work/full_correlation/kat/gul_S1_pltcalc_P5 & pid107=$!
eltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summaryeltcalc_P5 > work/full_correlation/kat/gul_S2_eltcalc_P5 & pid108=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarysummarycalc_P5 > work/full_correlation/kat/gul_S2_summarycalc_P5 & pid109=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarypltcalc_P5 > work/full_correlation/kat/gul_S2_pltcalc_P5 & pid110=$!
eltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_summaryeltcalc_P6 > work/full_correlation/kat/gul_S1_eltcalc_P6 & pid111=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_summarysummarycalc_P6 > work/full_correlation/kat/gul_S1_summarycalc_P6 & pid112=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_summarypltcalc_P6 > work/full_correlation/kat/gul_S1_pltcalc_P6 & pid113=$!
eltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summaryeltcalc_P6 > work/full_correlation/kat/gul_S2_eltcalc_P6 & pid114=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarysummarycalc_P6 > work/full_correlation/kat/gul_S2_summarycalc_P6 & pid115=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarypltcalc_P6 > work/full_correlation/kat/gul_S2_pltcalc_P6 & pid116=$!
eltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_summaryeltcalc_P7 > work/full_correlation/kat/gul_S1_eltcalc_P7 & pid117=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_summarysummarycalc_P7 > work/full_correlation/kat/gul_S1_summarycalc_P7 & pid118=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_summarypltcalc_P7 > work/full_correlation/kat/gul_S1_pltcalc_P7 & pid119=$!
eltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summaryeltcalc_P7 > work/full_correlation/kat/gul_S2_eltcalc_P7 & pid120=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarysummarycalc_P7 > work/full_correlation/kat/gul_S2_summarycalc_P7 & pid121=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarypltcalc_P7 > work/full_correlation/kat/gul_S2_pltcalc_P7 & pid122=$!
eltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_summaryeltcalc_P8 > work/full_correlation/kat/gul_S1_eltcalc_P8 & pid123=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_summarysummarycalc_P8 > work/full_correlation/kat/gul_S1_summarycalc_P8 & pid124=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_summarypltcalc_P8 > work/full_correlation/kat/gul_S1_pltcalc_P8 & pid125=$!
eltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summaryeltcalc_P8 > work/full_correlation/kat/gul_S2_eltcalc_P8 & pid126=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarysummarycalc_P8 > work/full_correlation/kat/gul_S2_summarycalc_P8 & pid127=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarypltcalc_P8 > work/full_correlation/kat/gul_S2_pltcalc_P8 & pid128=$!
eltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_summaryeltcalc_P9 > work/full_correlation/kat/gul_S1_eltcalc_P9 & pid129=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_summarysummarycalc_P9 > work/full_correlation/kat/gul_S1_summarycalc_P9 & pid130=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_summarypltcalc_P9 > work/full_correlation/kat/gul_S1_pltcalc_P9 & pid131=$!
eltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summaryeltcalc_P9 > work/full_correlation/kat/gul_S2_eltcalc_P9 & pid132=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarysummarycalc_P9 > work/full_correlation/kat/gul_S2_summarycalc_P9 & pid133=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarypltcalc_P9 > work/full_correlation/kat/gul_S2_pltcalc_P9 & pid134=$!
eltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_summaryeltcalc_P10 > work/full_correlation/kat/gul_S1_eltcalc_P10 & pid135=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_summarysummarycalc_P10 > work/full_correlation/kat/gul_S1_summarycalc_P10 & pid136=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S1_summarypltcalc_P10 > work/full_correlation/kat/gul_S1_pltcalc_P10 & pid137=$!
eltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summaryeltcalc_P10 > work/full_correlation/kat/gul_S2_eltcalc_P10 & pid138=$!
summarycalctocsv -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarysummarycalc_P10 > work/full_correlation/kat/gul_S2_summarycalc_P10 & pid139=$!
pltcalc -s < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarypltcalc_P10 > work/full_correlation/kat/gul_S2_pltcalc_P10 & pid140=$!
...
tee < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summary_P2 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summaryeltcalc_P2 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarypltcalc_P2 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarysummarycalc_P2 work/full_correlation/gul_S2_summaryaalcalc/P2.bin work/full_correlation/gul_S2_summaryleccalc/P2.bin > /dev/null & pid144=$!
...
tee < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summary_P3 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summaryeltcalc_P3 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarypltcalc_P3 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarysummarycalc_P3 work/full_correlation/gul_S2_summaryaalcalc/P3.bin work/full_correlation/gul_S2_summaryleccalc/P3.bin > /dev/null & pid146=$!
...
tee < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summary_P4 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summaryeltcalc_P4 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarypltcalc_P4 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarysummarycalc_P4 work/full_correlation/gul_S2_summaryaalcalc/P4.bin work/full_correlation/gul_S2_summaryleccalc/P4.bin > /dev/null & pid148=$!
...
tee < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summary_P5 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summaryeltcalc_P5 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarypltcalc_P5 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarysummarycalc_P5 work/full_correlation/gul_S2_summaryaalcalc/P5.bin work/full_correlation/gul_S2_summaryleccalc/P5.bin > /dev/null & pid150=$!
...
tee < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summary_P6 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summaryeltcalc_P6 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarypltcalc_P6 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarysummarycalc_P6 work/full_correlation/gul_S2_summaryaalcalc/P6.bin work/full_correlation/gul_S2_summaryleccalc/P6.bin > /dev/null & pid152=$!
...
tee < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summary_P7 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summaryeltcalc_P7 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarypltcalc_P7 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarysummarycalc_P7 work/full_correlation/gul_S2_summaryaalcalc/P7.bin work/full_correlation/gul_S2_summaryleccalc/P7.bin > /dev/null & pid154=$!
...
tee < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summary_P8 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summaryeltcalc_P8 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarypltcalc_P8 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarysummarycalc_P8 work/full_correlation/gul_S2_summaryaalcalc/P8.bin work/full_correlation/gul_S2_summaryleccalc/P8.bin > /dev/null & pid156=$!
...
tee < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summary_P9 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summaryeltcalc_P9 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarypltcalc_P9 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarysummarycalc_P9 work/full_correlation/gul_S2_summaryaalcalc/P9.bin work/full_correlation/gul_S2_summaryleccalc/P9.bin > /dev/null & pid158=$!
...
tee < /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summary_P10 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summaryeltcalc_P10 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarypltcalc_P10 /tmp/%FIFO_DIR%/fifo/full_correlation/gul_S2_summarysummarycalc_P10 work/full_correlation/gul_S2_summaryaalcalc/P10.bin work/full_correlation/gul_S2_summaryleccalc/P10.bin > /dev/null & pid160=$!
