...
tee < /tmp/%FIFO_DIR%/fifo/full_correlation/ri_S1_summary_P1 /tmp/%FIFO_DIR%/fifo/full_correlation/ri_S1_summaryeltcalc_P1 /tmp/%FIFO_DIR%/fifo/full_correlation/ri_S1_summarypltcalc_P1 /tmp/%FIFO_DIR%/fifo/full_correlation/ri_S1_summarysummarycalc_P1 work/full_correlation/ri_S1_summaryaalcalc/P1.bin > /dev/null & pid4=$!
